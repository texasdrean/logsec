...
- #### -> Architecture monolithique
  id:: 64462e3d-13cc-4b1a-b209-17933ca6058b
...
- #### -> Architecture de micro-services
  id:: 64462e3d-8d62-43a0-9a6b-5d1dbe4fa7d1
...
- #### -> Linus Torvalds
	- Créateur du noyau Linux, OS open source basé sur Unix.
		- Le noyau Linux a une ((64462e3d-13cc-4b1a-b209-17933ca6058b))
- #### -> Tanenbaum
	- Créateur de MINIX, OS de type Unix conçu pour l'éducation et la recherche
		- Le noyeau MINIX a une ((64462e3d-8d62-43a0-9a6b-5d1dbe4fa7d1))
-
...
- ### Concepts
- | ***Docker engine*** | "Moteur" qui permet d'exécuter des conteneurs |
  | ***Docker image*** | Modèle qui permet de créer des conteneurs |
  | ***Contenenur Docker*** | Instance en cours d'exécution d'une image Docker |
  | ***Network*** | Permet la communication entre les différents conteneurs |
  | ***Volumes*** | Permet de sauvegarder des données d’un conteneur |
- ### Docker engine
...
- ### Docker Network
	...
	- Docker met à disposition 4 modes pour le paramétrage réseau :
		- ((6445906b-9ccd-457b-ae15-daecdfe26ee1))
		- ((64459087-b941-4bd5-be9b-4683a4c1f553))
		- ((644592e5-f82f-4b20-ad7d-8b712023adfa))
		- ((644593ae-b1fe-4d33-b74b-863a3dead723))
		- ((6445947d-147e-42d1-817b-dcd537bb9d86))
-
- #### 1. Bridge (défaut)
  id:: 6445906b-9ccd-457b-ae15-daecdfe26ee1
